...
public class RemoteImplementation extends UnicastRemoteObject implements RemoteInterface{
	...
	//private HashMap<String, DrawingBoardMonitor> clientWhiteBoards;
	...
	public byte[] createWhiteBoard() throws RemoteException{
		...
		try {
			...
			if(this.BoardMonitor == null || this.BoardMonitor.getActive() == false) {
	...
	public byte[] getBoardStatus() throws RemoteException{	
		try {
			// Convert the buffered image to bytes and return
			BufferedImage outputImg = setTransparency(this.BoardMonitor.image);
			byte[] imageBytes = null;			
			ByteArrayOutputStream bos = new ByteArrayOutputStream();
	...
	public void clearContent() throws RemoteException{
		this.BoardMonitor.clearContent();
	}
